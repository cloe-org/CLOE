...
You can find the code dependencies listed `here <https://github.com/cloe-org/cloe/blob/main/environment.yml>`_.
...
More information about the structure of the repository can be found in the `README <https://github.com/cloe-org/CLOE/blob/main/README.md>`_.
