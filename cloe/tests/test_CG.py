...
class CGinitTestCase(TestCase):
    ...
    def test_sigma_z_M(self):
        npt.assert_allclose(
            self.cg.sigma_z_M(0.0, 10.0**14.0)[0][0],
    ...
    def test_nu_z_M(self):
        npt.assert_allclose(
            self.cg.nu_z_M(np.array([0.0]), 10.0**14.0)[0][0],
            self.check_nu_z_M,
            rtol=1e-3,
    ...
    def test_dlnsdlnR(self):
        npt.assert_allclose(
            self.cg.dlnsdlnR(np.array([0.0]), np.array([10.0**14.0]))[0][0],
            self.check_dlnsdlnR,
            rtol=1e-3,
    ...
    def test_f_sigma_nu(self):
        npt.assert_allclose(
            self.cg.f_sigma_nu(np.array([0.0]), np.array([10.0**14.0]))[0][0],
    ...
    def test_dndm(self):
        npt.assert_allclose(
            self.cg.dndm(np.array([0.0]), np.array([10.0**14.0]))[0][0],
            self.check_dndm,
            rtol=1e-3,
            err_msg="test_delta_c failed",
        )
    ...
    def test_lnlambda(self):
        npt.assert_allclose(
            self.cg.lnlambda(np.array([0.0]), np.array([10.0**14.0]))[0][0],
            self.check_lnlambda,
            rtol=1.0e-3,
    ...
    def test_scatter_lnlambda(self):
        npt.assert_allclose(
            self.cg.scatter_lnlambda(np.array([0.0]), np.array([10.0**14.0]))[0][0],
    ...
    def test_Pscaling_relation(self):
        npt.assert_allclose(
            self.cg.Pscaling_relation(
                np.array([0.0]), np.array([10.0**14.0]), np.array([30.0])
            )[0][0][0],
    ...
    def test_scatter_Plambda_obs(self):
        npt.assert_allclose(
            self.cg.scatter_Plambda_obs(np.array([0.0]), np.array([30.0]))[0][0],
    ...
    def test_Plambda_obs(self):
        npt.assert_allclose(
            self.cg.Plambda_obs(np.array([0.0]), np.array([30.0]), np.array([30.0]))[0][
                0
            ][0],
    ...
    def test_halo_bias(self):
        npt.assert_allclose(
            self.cg.halo_bias(
                np.array([0.0]), 10.0**14.0, self.cg.Delta("vir", 0.0, 0.0, 200)
            )[0][0],
    ...
    def test_cov_window(self):
        ...
        self.cg.KL = np.array([1.0, 2.0])
        npt.assert_allclose(
            self.cg.cov_window(0, np.array([0.5, 1.0]), 1.0, 1)[0][0:3],
    ...
    def test_number_counts(self):
        input_dir = (
            "./data/ExternalBenchmark/Clusters"
